...
func TestChiParamAdapter_Path(t *testing.T) {
...
func TestChiParamAdapter_PathWithoutContext(t *testing.T) {
	adapter := chiParamAdapter{}
	req := httptest.NewRequest("GET", "/users/123", nil)
...
func TestChiParamAdapter_Query(t *testing.T) {
	adapter := chiParamAdapter{}
...
func TestChiParamAdapter_Header(t *testing.T) {
	adapter := chiParamAdapter{}
...
func TestChiParamAdapter_Cookie(t *testing.T) {
	adapter := chiParamAdapter{}
	req := httptest.NewRequest("GET", "/test", nil)
