...
// PaymentIntentMetadata represents user-defined metadata for payment intent events.
// This can be customized by users to include their application-specific data.
...
// CustomerMetadata represents user-defined metadata for customer events.
...
// InvoiceMetadata represents user-defined metadata for invoice events.
